...
(function () {
  ...
  const I18N = {
    en: {
      ...
      ruleName: "Requirement name", criteriaPath: "Startup field path (e.g. dpiitStatus)", refValue: "Reference value (or JSON)", sourceRef: "Source reference (policy/authority)",
      saveDraft: "Save as DRAFT", saved: "Draft saved. Submit → approve → activate to apply.",
      evaluate: "Evaluate Eligibility", startup: "Startup", pickStartup: "Choose a startup", pickBoth: "Choose both challenge and startup",
      ...
      trust: "Trust", noSnapshot: "No assessment yet — choose a startup and run Evaluate.",
    ...
    hi: {
      ...
      ruleName: "आवश्यकता का नाम", criteriaPath: "स्टार्टअप फ़ील्ड पथ", refValue: "संदर्भ मान", sourceRef: "स्रोत संदर्भ",
      saveDraft: "ड्राफ़्ट सहेजें", saved: "सहेजा गया।",
      evaluate: "पात्रता का मूल्यांकन", startup: "स्टार्टअप", pickStartup: "स्टार्टअप चुनें", pickBoth: "चुनौती व स्टार्टअप चुनें",
