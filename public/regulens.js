...
(() => {
  ...
  const palette = (() => {
    ...
    function buildItems() {
      ...
      items.push({ group: "Navigate", icon: ICONS.updates, label: "Updates", hint: "updates", keywords: "updates feed changes", run: () => api.navigate("updates") });
      items.push({ group: "Navigate", icon: ICONS.impact, label: "Impact Analysis", hint: "impact", keywords: "impact analysis", run: () => api.navigate("impact-analysis") });
      items.push({ group: "Navigate", icon: ICONS.sim, label: "Policy Impact Simulator", hint: "policy", keywords: "policy simulator scenarios", run: () => api.navigate("policy-simulator") });
      items.push({ group: "Navigate", icon: ICONS.industry, label: "Industry Impact", hint: "industry", keywords: "industry impact", run: () => api.navigate("industry-impact") });
      items.push({ group: "Navigate", icon: ICONS.compare, label: "Compare Scenarios", hint: "compare", keywords: "compare scenarios markets", run: () => api.navigate("compare-scenarios") });
