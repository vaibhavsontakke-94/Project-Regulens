...
export function actionAllowed(action, role) {
  switch (action) {
    ...
    case "PROBLEM_CREATE":
    case "PROBLEM_UPDATE":
    case "PROBLEM_APPROVE":
    case "PROBLEM_PUBLISH":
    case "PROBLEM_CLOSE":
    case "PROBLEM_ARCHIVE":
    case "PROBLEM_REOPEN":
    case "PROBLEM_STRUCTURE_APPLY":
    case "PROBLEM_POLICY_INTELLIGENCE":
    case "CHALLENGE_CREATE":
    case "CHALLENGE_UPDATE":
    case "CHALLENGE_PUBLISH":
    case "CHALLENGE_SUBMIT_REVIEW":
    ...
    case "STARTUP_SUGGEST_RESOLVE":
      return ["ADMIN", "OFFICER", "STARTUP_ADMIN", "STARTUP_MEMBER", "EVALUATOR"].includes(role);
    case "STARTUP_PROFILE_EDIT":
      return ["ADMIN", "OFFICER", "STARTUP_ADMIN", "STARTUP_MEMBER"].includes(role);
    case "VERIFICATION_RECORD":
    case "STARTUP_VERIFY":
      return ["ADMIN", "OFFICER", "STARTUP_ADMIN"].includes(role);
    case "ELIGIBILITY_RULE":
    case "ELIGIBILITY_RULE_SUBMIT_REVIEW":
    case "ELIGIBILITY_RULE_ACTIVATE":
    case "ELIGIBILITY_RULE_DEACTIVATE":
      return ["ADMIN", "OFFICER", "PROCUREMENT_OFFICER"].includes(role);
    case "ELIGIBILITY_RULE_APPROVE":
    case "ELIGIBILITY_RULE_REJECT":
      return ["ADMIN", "OFFICER"].includes(role);
    case "ELIGIBILITY_CHECK":
    case "ELIGIBILITY_EVALUATE":
    case "ELIGIBILITY_REVIEW":
    case "ELIGIBILITY_REVIEW_ACTION":
    case "MATCH_RECORD":
    case "MATCHING_RUN":
    case "MATCHING_SHORTLIST":
      return ["ADMIN", "OFFICER", "PROCUREMENT_OFFICER", "EVALUATOR"].includes(role);
    case "ELIGIBILITY_REEVALUATE":
      return ["ADMIN", "OFFICER", "PROCUREMENT_OFFICER"].includes(role);
    case "MATCHING_CONFIG":
    case "MATCHING_HUMAN_ACTION":
      return ["ADMIN", "OFFICER", "PROCUREMENT_OFFICER"].includes(role);
    case "EVALUATION_CREATE":
    case "EVALUATION_SCORE":
    case "EVALUATION_STATUS":
    case "EVALUATION_ASSIST":
      return ["ADMIN", "OFFICER", "PROCUREMENT_OFFICER", "EVALUATOR"].includes(role);
    case "EVALUATION_CONFIG":
    case "EVALUATION_CRITERION_UPDATE":
    case "EVALUATION_ASSIGN":
    case "EVALUATION_LOCK":
    case "EVALUATION_REOPEN":
    case "EVALUATION_AGGREGATE":
    case "EVALUATION_DECISION":
    case "EVALUATION_PILOT_HANDOFF":
      return ["ADMIN", "OFFICER", "PROCUREMENT_OFFICER"].includes(role);
    ...
    case "APPLICATION_AI_ASSIST":
      return ["ADMIN", "OFFICER", "PROCUREMENT_OFFICER", "STARTUP_ADMIN", "STARTUP_MEMBER", "EVALUATOR"].includes(role);
    case "APPLICATION_REVIEW":
    case "APPLICATION_REQUEST_INFO":
