...
export function runDemoAnalysis({ company, product, origin, originRegion, target, targetRegion, industry, analysisId = null }) {
  ...
  analysisData.input = { company, product, origin: origin || "India", originRegion: originRegion || "", target: targetName, targetRegion: targetRegion || "", industry };
